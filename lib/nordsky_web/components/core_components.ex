defmodule NordskyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NordskyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NordskyWeb.Gettext, "errors", msg, opts)
    end
  end
